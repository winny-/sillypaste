...
class TestPasteForm(TestCase):
    ...
    def test_validate_expires_never(self):
        ...
        f.is_valid()
        self.assertEqual(f.save().expiry,
                         None)
    ...
    def test_validate_expires_custom_good(self):
        ...
        f = PasteForm({
            ...
            'custom_expiry_date': t.strftime(PasteForm.CUSTOM_EXPIRY_DATE_FORMAT),
            'custom_expiry_time': t.strftime(PasteForm.CUSTOM_EXPIRY_TIME_FORMAT),
        })
